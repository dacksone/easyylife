        ...
        <div>
          <article>
            <div class="mensaje">
              ...
              <p><img src="img/doctor4.png">
              </p><br/><br/>
              <p>Bienvenido <b><?php echo $_SESSION['usuario'];?></b> a <b>Easy Life</b>! Un Sistema de Citas Médicas para  exámenes médicos de ingreso.</p>
              <br/><br/>
              <h3>Nuestras funciones</h3><br/>
              <p>	- Gestión de Citas <br/>
                - Gestión de Médicos <br/>
                - Gestión de Pacientes <br/>
                - Gestión de Consultorios <br/>
