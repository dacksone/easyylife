  ...
  <div class="main_container">
      ...
      <div class="container">
                  ...
                  <div class="form-group">
                      <label class="col-lg-4 control-label"><Strong>Tipo de Consultorio</Strong></label>
                        <div class="col-md-8"> 
                          <input id="fname" name="nombre" type="text" placeholder="Ejemplo: Pediatría" class="form-control btn-sm"> 
                          <p>
                          </p>
                          <button class="btn btn-primary btn-sm" type="submit">Agregar Consultorio</button>
                        </div>
                    </div>
					</form>
